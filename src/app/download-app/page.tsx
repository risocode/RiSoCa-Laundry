    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="flex flex-col items-center text-center">
            ...
            <p className="text-lg text-muted-foreground mt-2 max-w-2xl">Get the full RKR Laundry experience on your mobile device. Track orders, get exclusive deals, and more.</p>

            <div className="mt-12 flex flex-col md:flex-row items-center gap-8">
                <div className="flex flex-col gap-4">
                    <Button size="lg" className="h-16 text-lg w-64 bg-black text-white hover:bg-gray-800">
