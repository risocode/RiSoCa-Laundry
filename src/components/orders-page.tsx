...
export function OrdersPage() {
  ...
  const fetchOrders = async () => {
    ...
    console.log('[Orders Page] Fetched orders:', data?.length, 'orders');
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', 
        ...
        (payload) => {
          console.log('[Orders Page] Order changed:', payload);
          console.log('[Orders Page] Event type:', payload.eventType);
